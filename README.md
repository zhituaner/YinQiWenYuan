# `.py` 使用说明（v1.0）
:!:因GitHub上传限制，此处不含**selenium浏览器驱动**，请根据**浏览器版本**自行[下载](https://www.cnblogs.com/momolei/p/10118526.html)，并将其放在**Python安装目录**下（或添加至**环境变量**）。本程序**当前仅支持GoogleChrome**，如有其他需求请自行修改源码。
